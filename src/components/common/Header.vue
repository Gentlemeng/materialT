<template>
  <div class="header">
    ...
    <div class="welcome">
      <div class="wel-box">
        <div class="wel-text">您好！欢迎光临：邯郸市壮达物资有限公司！</div>
        <div class="contact">
    ...
    <nav :class="[isShowMenu? 'active' : '','mobile_nav']">
      <ul class="mobile_nav_ul">
        <li
          class="mobile_nav_list"
          v-for="item in navData"
          :key="item.index"
        >
         
          <p><router-link :to="{path: '/' + item.index}">{{item.title}} </router-link></p>
        </li>
      </ul>
